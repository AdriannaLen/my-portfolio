const Me = () => {
  return (
    <div id="me" className="bg-slate-100 pb-[2rem] relative min-h-[100vh] flex flex-col lg:flex-row lg:justify-start items-start">
      ...
      {/* Sekcja tekstowa */}
      <div className="mt-[8rem] sm:ml-[14rem] lg:ml-[20%] flex flex-col lg:flex-row lg:items-start h-full w-full lg:w-auto">
        <div className="flex-1">
          <h2 className="font-greatVibes text-slate-800 text-[2rem] sm:text-[2.5rem] lg:text-[3rem]">
            Hi !
          </h2>
          <p className="font-poppins mt-0 w-full sm:w-[70%] md:w-full lg:w-[60%] text-black text-[0.875rem] sm:text-[1rem] md:text-[1.125rem] lg:text-[1.125rem] leading-relaxed space-y-[1rem] p-[1.5rem] rounded-lg">
