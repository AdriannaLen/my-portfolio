const Me = () => {
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row lg:items-start h-full lg:ml-32 mt-4">
      <div className="hidden sm:block h-full w-0.5 bg-black"></div>
      <p className="font-poppins ml-4 mt-4 text-center w-full lg:w-[45%] text-black text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed space-y-4 p-6 rounded-lg">
