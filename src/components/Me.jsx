...
const Me = () => {
  return (
      <div id="me" className="h-[100vh] flex flex-col items-center lg:flex-row lg:justify-around">
        <p className="font-poppins mt-20 text-center w-[45%] text-black text-lg sm:text-xl leading-relaxed space-y-4 p-6 rounded-lg transition-transform duration-500 hover:scale-105 animate-fadeIn">
