...
const Me = () => {
  return (
    <div id="me" className="relative h-[100vh] flex flex-col lg:flex-row lg:justify-start">
    <div className="flex flex-col lg:flex-row lg:items-center h-full lg:ml-32">
        <div className="h-full w-0.5 bg-black"></div>
        <p className="font-poppins ml-4 mt-20 text-center w-[45%] text-black text-lg sm:text-xl leading-relaxed space-y-4 p-6 rounded-lg transition-transform duration-500 hover:scale-105 animate-fadeIn">
