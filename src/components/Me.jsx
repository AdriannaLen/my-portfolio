  ...
  return (
    <div id="me" className="bg-slate-100 relative h-[100vh] flex flex-col lg:flex-row lg:justify-start items-start">
      <div className="mt-32 flex flex-col lg:flex-col top-0 lg:items-start h-full lg:ml-32">
        ...
        <p className="font-poppins ml-4 mt-0 w-full lg:w-[45%] text-black text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed space-y-4 p-6 rounded-lg">
        ...
        <ul className="font-poppins ml-4 w-full lg:w-[45%] text-black text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed space-y-4 p-6 rounded-lg">
