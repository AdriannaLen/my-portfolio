        ...
        {careerTimeline.map((event, index) => (
          <div key={index} className="mb-10 ml-6">
            ...
            <div className="flex items-center mb-1">
              <span className="text-lg font-poppins font-semibold text-text dark:text-white">
                {event.year}
              </span>
              <span className="mx-2">-</span>
              <span className="text-lg font-poppins font-semibold text-text dark:text-gray-300">
                {event.title}
              </span>
            </div>
            <p className="text-base font-normal text-text dark:text-gray-400">
              {event.description}
            </p>
          </div>
        ))}
