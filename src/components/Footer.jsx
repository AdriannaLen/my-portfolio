...
const Footer = () => {
  return (
    <>
      <div className="bg-lightPeach text-center py-8 flex flex-col sm:flex-row justify-around border-t border-black">
      ...
      <div className="font-poppins pb-8 text-text bg-lightPeach text-center flex flex-col sm:flex-row justify-around">
        <p>
