    ...
    <div className="flex flex-col sm:flex-row justify-between items-start w-full max-w-6xl p-4 sm:p-8">
      ...
      <div className="w-full sm:w-1/2 flex-shrink-0 text-start mt-8 sm:mt-0 relative">
        <div className="p-8 font-poppins bg-white h-full text-lg relative z-10 sm:-translate-y-[15%]">
          ...
          <p>Anything you'd like to ask about? Please contact me using the form !</p>
      ...
      <div className="w-full sm:w-1/2 mt-[20vh] sm:mt-0 flex-shrink-0 relative z-10 -translate-y-[25%] sm:mr-8 lg:mr-[25%]">
        <form className="bg-lightPeach p-8 border w-full h-auto relative">
          ...
          <div className="flex items-center mt-4">
            ...
            <label className="text-sm">Zgadzam się na <a href="#" className="text-text">politykę prywatności</a></label>
          </div>
          <button type="submit" className="w-full bg-lightCoral text-white p-3 rounded-lg font-bold hover:bg-customBlue transition duration-300 mt-4">
            Send
          </button>
        </form>
      </div>
