  ...
  return (
    <div id="contact" className="bg-white min-h-screen sm:min-h-[70vh] flex justify-center items-center relative py-16">
      <div className="flex flex-col sm:flex-row justify-between items-start w-full max-w-6xl p-4 sm:p-8">
        ...
        <div className="w-full sm:w-1/2 max-w-lg flex-shrink-0 relative z-10 -mt-24 sm:-mt-48">
        ...
        {/* Dane kontaktowe */}
        <div className="w-full sm:w-1/2 max-w-lg flex-shrink-0 text-center mt-8 sm:mt-0">
          <div className="p-8 font-poppins bg-white border h-full">
            <p className="mb-2 text-[32px]">Kontakt</p>
            ...
            <a href="https://github.com/AdriannaLen" className="hide-on-mobile"><img src={github} alt="github" className="object-contain" /></a>
        ...
        <div className="hidden sm:block absolute h-full w-0.5 bg-slate-600 mr-32 lg:right-0 top-0"></div>
      </div>
    </div>
  );
};
